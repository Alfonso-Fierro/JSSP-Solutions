...
from grasp_alpha_selection   import restricted_list

def grasp(archivo, iters = 10, alpha = 0.5):
    ...
    indices = restricted_list(trabajos,rango,alpha)
    for i in indices:
